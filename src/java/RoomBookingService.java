...
public class RoomBookingService {
    ...
    //Book a room for a pt session if any available
    public boolean bookRoomForPTSession(PT_Session session, ROOM room) {
        if(isRoomAvailable(room, session.getStartTime(), session.getEndTime())) {
